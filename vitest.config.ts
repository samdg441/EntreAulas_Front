  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/features/evaluations/evaluacion-docente.ts',
        'src/features/evaluations/resumen-ia.ts',
        'src/features/evaluations/alerta-acoso.ts',
        ...
        'src/features/dashboard-student/estudiante-stats.ts',
