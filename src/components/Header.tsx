...
export default function Header({
  ...
  // Menú de perfil / cerrar sesión si hay prop o sesión activa
  const showUserControls = Boolean(user) || isAuthenticated || Boolean(authUser)
  ...
  return (
    <>
      <motion.header
        ...
        className="bg-white border-b border-gray-200 px-3 sm:px-4 lg:px-4 py-4 sm:py-6 lg:py-1 relative z-30"
      >
          ...
          <div className="flex items-center justify-between w-full">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="hidden sm:block">
                <h1 className="text-sm sm:text-lg lg:text-xl font-semibold text-gray-900">
                  EntreAulas
                </h1>
            ...
            <div className="flex items-center gap-2 sm:gap-4 relative z-40">
              {showUserControls && (
                <>
